...
const AddTourPackages = () => {
    ...
    return (
        <>
            <div>
            <h1 class="text-2xl font-semibold text-gray-800">Add Tour Packages</h1>
            <p class="mt-4 text-gray-600">Easily create and manage tour packages for your customers. Provide package details such as title, description, price, and duration, and upload stunning images to showcase your offerings.</p>
            </div>
